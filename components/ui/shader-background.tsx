...
const fsSource = `
  ...
  const vec4 lineColor = vec4(0.784, 0.333, 0.239, 1.0);
  ...
  void main() {
    ...
    vec4 lines = vec4(0.0);
    vec4 bgColor1 = vec4(0.075, 0.114, 0.071, 1.0);
    vec4 bgColor2 = vec4(0.176, 0.239, 0.173, 1.0);
...
export default function ShaderBackground({ className = 'absolute inset-0 w-full h-full' }: ShaderBackgroundProps) {
  ...
  useEffect(() => {
    ...
    // Pause GPU work when hero is scrolled off-screen or tab is hidden
